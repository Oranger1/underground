...
public class secretUtils {
    ...
    // 加密密文，私钥
    public static final String JWT_SECRET = "ticketsecret";
...
//				.setHeader(header) // 设置头部信息
    ...
    public Manager getManagerByToken(String jwt){
        SecretKey key = generalKey();
        Claims claims = Jwts.parser()
                .setSigningKey(key)
                .parseClaimsJws(jwt).getBody();
        String json = claims.getSubject();
        return JSONUtils.parseIgnoreErrors(json,Manager.class);
    }
